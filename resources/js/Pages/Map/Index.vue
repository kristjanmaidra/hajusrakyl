                    ...
                    <table class="">
                        ...
                        <tr v-for="map in maps" :key="map.id" class="">
                            ...
                            <td class=" flex gap-2 py-3 items-center justify-center">
                                <Link class="bg-gray-800 text-white font-bold text-sm uppercase px-2 py-1 rounded">Edit</Link>
                                <Link class="bg-red-500 text-white font-bold text-sm uppercase px-2 py-1 rounded" as="buttton" method="post">Delete</Link>
                            </td>
                        </tr>
                    </table>
                </div>
